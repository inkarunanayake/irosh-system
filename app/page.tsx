    ...
    <main className="bg-black text-white min-h-screen">
      ...
      <div className="fixed top-5 right-5 z-50 flex gap-3">
        ...
        <button
          ...
          className="bg-zinc-900 hover:bg-red-600 border border-zinc-700 px-4 py-2 rounded-xl text-sm font-semibold"
        >
        ...
        <button
          ...
          className="bg-zinc-900 hover:bg-blue-600 border border-zinc-700 px-4 py-2 rounded-xl text-sm font-semibold"
        >
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6">
          ...
          <h1 className="text-5xl md:text-8xl font-black mb-6 tracking-wider">

            <span className="text-white">IROSH</span> <span className="text-red-500">ENTERTAINMENT</span>
      ...
      >
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-center text-gray-400 mb-12">
            Reserve your event date and our team will contact you.
          </p>
